  ...
  ui(new Ui::CAboutDlg)
{
  ...
  ui->labelTxt->setText ("<html><h2>"
                         ...
                         "It is created with contributions from 9A5CW, CE2EC, CT1AXS, DK7UY, DO1IP, <br>"
                         "EA1AHY, EA7QL, ES2HV, ES4RLH, ES5TF, F1DSZ, F5RUE, G7OED, IZ5ILJ, JA2BQX, <br>"
                         "JP1LRT, LU9DO, MM0HVU, N6ML, NL9222, OE1MWW, ON3CQ, R3BB, RK3AOL, RA4UDC, RW4O, <br>" 
