  ...
  ui(new Ui::CAboutDlg)
{
  ...
  ui->labelTxt->setText ("<html><h2>"
                         ...
                         "It is created with contributions from 9A5CW, CE2EC, CT1AXS, DK7UY, DO1IP, EA1AHY,<br>"
                         "EA7QL, ES2HV, ES4RLH, ES5TF, F1DSZ, F5RUE, G7OED, IZ5ILJ, JA2BQX, JG1APX, JP1LRT,<br>"
                         "LU9DO, MM0HVU, N6ML, NL9222, OE1MWW, ON3CQ, R3BB, RK3AOL, RA4UDC, RW4O, <br>" 
                         "R0JF, SP2L, SV1IYF, UA3ALE, US-E-12, VE3NEA, VK3AMA, VK6KXW, VK7YUM, VR2UPU <br>"
