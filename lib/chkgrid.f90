...
! USA AA..AL,K,N,W
    if(callsign(2:2).gt.'@' .and. callsign(2:2).lt.'M') then
      if((grid(1:2).eq.'FM' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'3' .and. grid(4:4).gt.'1' .and. grid(4:4).lt.':').or. &
       ...
       grid(1:2).eq.'BP' .or. &
       (grid(1:2).eq.'BO' .and. grid(3:3).gt.'3' .and. grid(3:3).lt.':') .or. &
       ...
       (grid(1:2).eq.'RO' .and. grid(3:3).gt.'5' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'/' .and. grid(4:4).lt.'3') .or. &
...
! Argentina AY,AZ, L1..L9, LO..LW
        ...
        if((grid(1:2).eq.'GF' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'2' .and. grid(4:4).gt.'0'.and.grid(4:4).lt.':').or. &
           ...
           (grid(1:2).eq.'FD' .and. grid(3:3).gt.'2' .and. grid(3:3).lt.'8' .and. grid(4:4).gt.'3'.and.grid(4:4).lt.':').or. &
...
! India 8T..8Y,AT..AW,VT..VW
        ...
        if((grid(1:2).eq.'MJ' .and. grid(3:3).gt.'7' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'7'.and.grid(4:4).lt.':').or. &
           ...
           (grid(1:2).eq.'NK' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'4' .and. grid(4:4).gt.'1'.and.grid(4:4).lt.':').or. &
...
! China, Taiwan B, 3H..3U, XS
    if(grid(1:2).eq.'OL' .or. &
       ...
       (grid(1:2).eq.'OK' .and. (grid(1:2).eq.'48' .or. grid(1:2).eq.'49' .or. grid(1:2).eq.'58' .or.grid(1:2).eq.'59')).or. &
...
! Canada CF..CK,CY,CZ,VA..VG,VO,VX,VY,XJ..XO
      ...
      if((grid(1:2).eq.'CN' .and. grid(3:3).gt.'5' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'7' .and. grid(4:4).lt.':').or. &
         ...
         grid(1:2).eq.'CP' .or. grid(1:2).eq.'DP' .or. grid(1:2).eq.'EP' .or.grid(1:4).eq.'GN03'.or.grid(1:4).eq.'FN93' .or. &
         grid(1:4).eq.'ER60') lgvalid=.true.
...
! Bosnia-Herzegovina E7
      ...
      if(grid(1:2).eq.'JN' .and. grid(3:3).gt.'6' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'1' .and. grid(4:4).lt.'6') &
        lgvalid=.true.
...
! not valid callsigns
    else if(callsign(1:2).eq.'E1') then
      lwrongcall=.true.; return
...
! Italy, Sardinia I
    ...
    if(grid(1:2).eq.'JM' .and. (grid(3:4).eq.'69' .or. grid(3:4).eq.'86' .or. grid(3:4).eq.'96' .or. grid(3:4).eq.'97' .or. &
       grid(3:4).eq.'98')) lgvalid=.false.
    if(grid(1:2).eq.'JN' .and. &
       ((grid(3:3).eq.'7' .and. grid(4:4).gt.'2' .and. grid(4:4).lt.'8') .or. &
        ...
        grid(3:4).eq.'30' .or. grid(3:4).eq.'31' .or. grid(3:4).eq.'50')) lgvalid=.false.
...
! Japan 7J..7N,8J..8N,JA,JE..JS
    if(callsign(1:2).eq.'JA' .or. (callsign(2:2).gt.'D' .and. callsign(2:2).lt.'T')) then
      ...
      if(grid(1:2).eq.'PM' .and. ((grid(3:3).gt.'3' .and. grid(3:3).lt.'8' .and. grid(4:4).gt.'6' .and.grid(4:4).lt.':').or. &
         ...
         grid(3:4).eq.'89')) lgvalid=.false.
      if(grid(1:2).eq.'PL' .and. ((grid(3:3).gt.'0' .and. grid(3:3).lt.'3' .and. grid(4:4).gt.'4' .and.grid(4:4).lt.':').or. &
         grid(3:4).eq.'38' .or. grid(3:4).eq.'39' .or. grid(3:4).eq.'57' .or. grid(3:4).eq.'59')) lgvalid=.false.
      if(grid(1:2).eq.'QN' .and. ((grid(3:3).eq.'2' .and. (grid(4:4).eq.'0' .or. grid(4:4).eq.'1' .or.grid(4:4).eq.'5')).or. &
         grid(3:4).eq.'10')) lgvalid=.false.
...
! Indonesia  7A..7I, 8A..8I, PK..PO, YB..YH
      ...
      if(grid(1:2).eq.'PJ' .and. ((grid(3:3).gt.'/' .and. grid(3:3).lt.'2' .and. grid(4:4).gt.'1' .and.grid(4:4).lt.'5').or. &
         grid(3:4).eq.'43' .or. grid(3:4).eq.'44')) lgvalid=.false.
      if(grid(1:2).eq.'NJ' .and. ((grid(3:3).eq.'6' .and. grid(4:4).gt.'/' .and. grid(4:4) .lt.'6') .or. &
         ...
         grid(3:4).eq.'43' .or. grid(3:4).eq.'44' .or. grid(3:4).eq.'95')) lgvalid=.false.
      if(grid(1:2).eq.'OJ' .and. ((grid(3:3).gt.'4' .and. grid(3:3).lt.'7' .and. grid(4:4).gt.'1'.and. grid(4:4).lt.'5').or. &
         (grid(3:3).eq.'1' .and. grid(4:4).gt.'1' .and. grid(4:4).lt.'5').or. &
         grid(3:4).eq.'24' .or. grid(3:4).eq.'04')) lgvalid=.false.
      if(grid(1:2).eq.'OI' .and. ((grid(4:4).eq.'1' .and. grid(3:3).gt.'1'.and. grid(3:3).lt.'5') .or. &
         (grid(4:4).eq.'5' .and. grid(3:3).gt.'2'.and. grid(3:3).lt.'6') .or. &
         grid(3:4).eq.'44' .or. grid(3:4).eq.'39')) lgvalid=.false.
      if(grid(1:2).eq.'PI' .and. (grid(3:4).eq.'61' .or. grid(3:4).eq.'62' .or. grid(3:4).eq.'71' .or. grid(3:4).eq.'83'.or. &
...
! Mauritania 5T
        ...
        if((grid(1:2).eq.'IK' .and. grid(3:3).gt.'0' .and. grid(3:3).lt.'8' .and. grid(4:4).gt.'4'.and.grid(4:4).lt.':').or. &
           (grid(1:2).eq.'IL' .and. grid(3:3).gt.'0' .and. grid(3:3).lt.'7' .and. grid(4:4).gt.'/'.and.grid(4:4).lt.'7').or. &
           grid(1:2).eq.'IK' .and. (grid(3:4).eq.'34' .or. grid(3:4).eq.'44') .or. &
           grid(1:2).eq.'IL' .and. (grid(3:4).eq.'57' .or. grid(3:4).eq.'75')) lgvalid=.true.
...
! Algeria 7R, 7T..7Y
        ...
        (grid(1:2).eq.'JL' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'6') .or. &
        (grid(1:2).eq.'IL' .and. grid(3:3).gt.'4' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'1' .and. grid(4:4).lt.':') .or. &
        (grid(1:2).eq.'JK' .and. grid(3:3).gt.'0' .and. grid(3:3).lt.'4' .and. grid(4:4).eq.'9') .or. &
        grid(1:4).eq.'JM37' .or. grid(1:4).eq.'IM70') lgvalid=.true.
...
! Croatia 9A
      if(callsign(1:2).eq.'9A') then
        if(grid(1:2).eq.'JN' .and. grid(3:3).gt.'5' .and. grid(3:3).lt.':' .and.grid(4:4).gt.'1'.and.grid(4:4).lt.'7') &
          lgvalid=.true.
...
! Dem. Rep. of the Congo 9O..9T
        ...
        if((grid(1:2).eq.'JI' .and. grid(3:3).gt.'5' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'1'.and.grid(4:4).lt.':').or. &
           (grid(1:2).eq.'KI' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'6') .or. &
           (grid(1:2).eq.'KJ' .and. grid(3:3).gt.'/' .and. grid(3:3).lt.'6' .and. grid(4:4).gt.'/'.and.grid(4:4).lt.'6').or. &
           (grid(1:2).eq.'JJ' .and. grid(3:3).gt.'7' .and. grid(3:3).lt.':' .and. grid(4:4).gt.'/'.and.grid(4:4).lt.'5').or. &
           (grid(1:2).eq.'KH' .and. grid(3:3).gt.'0' .and. grid(3:3).lt.'5' .and. grid(4:4).gt.'5'.and.grid(4:4).lt.':').or. &
           grid(1:4).eq.'JI81' .or. grid(1:4).eq.'JJ95') lgvalid=.true.
