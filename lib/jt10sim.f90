...
! Generate simulated data for testing of WSJT-X
  ...
  nargs=iargc()
  if(nargs.ne.6) then
     print*,'Usage:   jt10sim "message"     fspan nsigs minutes SNR nfiles'
     print*,'Example: jt10sim "CQ K1ABC FN42" 200  20      2    -28    1'
     print*,' '
...
!  f0=1400.d0                         !Center frequency (Hz)
   f0=1750.d0                         !Center frequency (Hz) 
...
1002 format('000000_',i4.4)
     ...
     if(msg0.ne.'                      ') then
        call gen10(message,0,msgsent,i4tone,itype) !Encode message into tone #s
     endif
...
1004       format(a22)
           call gen10(message,0,msgsent,i4tone,itype)
        endif
...
!        k=24000                             !Start audio at t = 2.0 s
!        f1=0.0001 * (ifile-1)
        f1=0.
!        print*,ifile-1,f1
        dphi2=0.
